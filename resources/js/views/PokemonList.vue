<template>
    <div>
        ...
        <modal name="success" classes="demo-modal-class" height="auto" width="100%" :scrollable="true">
            <div class="size-modal-content">
                <table>
                    <tr>
                        <td><b style="font-size: 20px;">Success To Catch {{this.detailPokemon.name}}</b></td>
                    </tr>
                    <tr>
                        <td><b style="font-size: 20px;">Give NickName?</b><hr></td>
                    </tr>
                    <tr>
                        <td>
                            <div class="col-sm-4">
                                <label><b>Pokemon Nick Name:</b></label>
                                <input type="text" v-model="nickname" class="form-control" placeholder="">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <a @click="giveNickName()" class="btn btn--primary" href="#">
                                <span class="btn__text">Give</span>
                            </a> 
                            <a @click="hideNick()" class="btn btn--success" href="#">
                                <span class="btn__text">Not Give</span>
                            </a>
                        </td>
                    </tr>
                </table>
        ...
        <modal name="detail" classes="demo-modal-class" height="auto" width="100%" :scrollable="true">
            <div class="size-modal-content">
                <table>
                    ...
                    <tr>
                        <td>
                            <a @click="catchPokemon()" class="btn btn--primary" href="#">
                                <span class="btn__text">Catch</span>
                            </a> 
        ...
        <modal name="loading" classes="demo-modal-class" height="auto" width="100%" :scrollable="true">
            <div class="size-modal-content">
                <table>
                    ...
                    <tr>
                        <img src="https://media.giphy.com/media/iBANmdIlMNJVC/giphy.gif" alt="this slowpoke moves"  width=250/>
                    </tr>
                </table>
            </div>        
        </modal>

        <modal name="catch" classes="demo-modal-class" height="auto" width="100%" :scrollable="true">
            <div class="size-modal-content">
                <table>
                    <tr>
                        <td><hr><b style="font-size: 50px;">...Waiting to catch Pokemon...</b><hr></td>
                    </tr>
                    <tr>
                        <img src="https://media.giphy.com/media/j2xgBIuAgmrpS/giphy.gif" alt="this slowpoke moves"  width=250/>
                    </tr>
                </table>
            </div>        
        </modal>
...
export default {
    ...
    methods: {
        giveNickName () {
            ...
            data.id = this.detailPokemon.id
            data.moves = this.detailPokemon.moves
            data.nickname = this.nickname

            axios.post('/api/catchPokemon', data).then(response => {
                this.playSound(3)

                this.$swal({
                  icon: 'success',
                  title: 'Success to give nickname '+this.nickname,
        ...
        catchPokemon () {
            ...
            setTimeout(() => {
                ...
                if (x < 50){
                    ...
                    this.$swal({
                      icon: 'error',
                      title: 'Fail to catch '+this.detailPokemon.name,
                      showConfirmButton: false,
                      timer: 2500
                    })
                    this.$modal.hide('catch');
                }else{
                    var data = {}
                    ...
                    axios.post('/api/catchPokemon', data).then(response => {
                        ...
                        this.$swal({
                          icon: 'success',
                          title: 'Success to catch '+this.detailPokemon.name,
                          showConfirmButton: false,
                          timer: 2500
                        })
        ...
        openDetail(value){
            ...
            axios.get('/api/getDetail/'+value.id).then(response => {
        ...
        playSound(value){
            if(value==1){
                var audio = new Audio('sound/detail.mp3');
            }else if(value==2){
